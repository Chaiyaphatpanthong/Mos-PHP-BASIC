...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="#"> <img src="OIP (1).jpg" alt="" width="30" height="24">  <i class="bi bi-diamond-half"></i> Black&White</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i>
            ดูเพิ่มเติม
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item text-dark" href="#">หมู</a></li>
            <li><a class="dropdown-item text-dark" href="#">หมา
            <li><a class="dropdown-item text-dark" href="#">กา
            <li><a class="dropdown-item text-dark" href="#">ไก่</a></li>
          </ul>
        </li>
